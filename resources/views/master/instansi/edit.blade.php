        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-warning text-dark">
                    <h5 class="mb-0">
                        <i class="fas fa-edit"></i> Edit Instansi: {{ $instansi->nama_instansi }}
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('master.instansi.update', $instansi) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi_instansi') is-invalid @enderror" 
                                      ...
                                      rows="3"
                                      placeholder="Deskripsi singkat tentang instansi">{{ old('deskripsi_instansi', $instansi->deskripsi_instansi) }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       name="is_active" 
                                       value="1" 
                                       {{ old('is_active', $instansi->is_active) ? 'checked' : '' }}>
