        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-plus-circle"></i> Tambah Aplikasi Baru
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('master.master-app.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi_app') is-invalid @enderror" 
                                      ...
                                      name="deskripsi_app" 
                                      rows="3"
                                      placeholder="Deskripsi singkat tentang aplikasi">{{ old('deskripsi_app') }}</textarea>
                            @error('deskripsi_app')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
