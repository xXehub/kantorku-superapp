                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="search" class="form-control"
                                        placeholder="Nama atau kode aplikasi..." value="{{ request('search') }}">
                                </div>
                                <div class="col-md-3">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <span class="badge bg-secondary">{{ $apps->where('is_active', 0)->count() }}
                                Nonaktif</span>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                @foreach ($apps as $app)
                                    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
                                        <div
                                            class="card h-100 border {{ $app->is_active ? 'border-success' : 'border-secondary' }}">
                                            <div class="card-body d-flex flex-column">
                                                <div class="text-center mb-3">
                                                    @if ($app->logo_app)
                                                        <img src="{{ asset('storage/' . $app->logo_app) }}"
                                                            alt="Logo {{ $app->nama_app }}" class="rounded-circle"
                                                            style="width: 60px; height: 60px; object-fit: cover;">
                                                    @else
                                                        <div class="bg-{{ $app->is_active ? 'primary' : 'secondary' }} text-white rounded-circle d-inline-flex align-items-center justify-content-center"
                                                ...
                                                <div class="mt-auto">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="btn-group" role="group">
                                                            <a href="{{ route('panel.apps.show', $app->id) }}"
                                                                class="btn btn-outline-info btn-sm">
                                                                <i class="fas fa-eye"></i> Detail
                                                            </a>
                                                            @if (auth()->user()->isSuperAdmin() ||
                                                                    (auth()->user()->isAdmin() && auth()->user()->instansi_id == $app->instansi_id) ||
                                                            ...
                                                            @if (auth()->user()->isSuperAdmin())
                                                                <button type="button"
                                                                    ...
                                                                    onclick="confirmDelete({{ $app->id }}, '{{ $app->nama_app }}')">
