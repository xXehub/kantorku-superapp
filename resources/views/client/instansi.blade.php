            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="h1 mb-0 text-success">{{ $instansi->apps->where('is_active', true)->count() }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                                        ...
                                        <div class="card h-100">
                                            <div class="card-body d-flex flex-column">
                                                <div class="text-center mb-3">
                                                    <span class="avatar avatar-lg {{ $app->is_active ? 'bg-primary' : 'bg-secondary' }}">
                                                ...
                                                <div class="mt-auto">
                                                    ...
                                                    <div class="btn-list w-100">
                                                        @if($app->url_app && $app->is_active)
                                                            <a href="{{ $app->url_app }}" target="_blank" class="btn btn-primary w-100">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                                                        ...
                                                        @if($hasManagementAccess || (auth()->user()->app_id == $app->id))
                                                            <a href="{{ route('panel.apps.edit', $app->id) }}" class="btn btn-outline-warning w-100 mt-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                                                                    <path d="M10.325 4.317c.426 -1.756 2.924 -1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756 -2.924 1.756 -3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543 .94 -3.31 -.826 -2.37 -2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756 -.426 -1.756 -2.924 0 -3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z" />
                                                                    <path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" />
                                                                </svg>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                @if($instansi->telepon)
                                    <div class="col-md-4 mb-3">
                                        <strong>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon text-green me-1">
