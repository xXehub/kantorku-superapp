  <body>
      ...
      <script src="./dist/js/tabler-theme.min.js?1744816591"></script>
                  ...
                  <div>
                      ...
                      <div class="mb-4">
                          ...
                          <div>
                              ...
                              <label class="form-check">
                                  <div class="form-selectgroup-item">
                                      <input type="radio" name="theme-base" value="gray"
                                          class="form-check-input" checked />
      ...
      <script src="./dist/js/tabler.min.js?1744816591" defer></script>
      <!-- END GLOBAL MANDATORY SCRIPTS -->
      <!-- BEGIN DEMO SCRIPTS -->
      <script src="./preview/js/demo.min.js?1744816591" defer></script>
      <!-- END DEMO SCRIPTS -->
      <!-- BEGIN PAGE SCRIPTS -->
      <script>
