                    ...
                    <div class="col">
                        ...
                        <ul class="navbar-nav">
                            @if (request()->routeIs('panel.*'))
                                    ...
                                    <a class="nav-link" href="{{ route('panel.dashboard') }}">
                                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="icon icon-1">
                                                <path
                                                    d="M3 13c0 -3.771 0 -5.657 1.172 -6.828s3.057 -1.172 6.828 -1.172s5.657 0 6.828 1.172s1.172 3.057 1.172 6.828s0 5.657 -1.172 6.828s-3.057 1.172 -6.828 1.172s-5.657 0 -6.828 -1.172s-1.172 -3.057 -1.172 -6.828z" />
                                ...
                                {{-- Management modules based on user permissions --}}
                                @if (auth()->user()->isSuperAdmin())
                                    ...
                                    <li class="nav-item {{ request()->routeIs('panel.apps*') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('panel.apps.index') }}">
                                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <li class="nav-item {{ request()->routeIs('panel.instansi*') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('panel.instansi.index') }}">
                                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                @else
                                    {{-- Show only modules user has permissions for --}}
                                        ...
                                        <li class="nav-item {{ request()->routeIs('panel.apps*') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('panel.apps.index') }}">
                                                ...
                                                <span class="nav-link-title">
                                                    @if (auth()->user()->isAdmin() && auth()->user()->app_id)
                                                        Aplikasi Saya
                                                    @else
                                                        Aplikasi
                                                    @endif
                                    ...
                                    @if (auth()->user()->hasPermission('instansi.view'))
                                        <li
                                            class="nav-item {{ request()->routeIs('panel.instansi*') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('panel.instansi.index') }}">
                                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24" viewBox="0 0 24 24" fill="none"
